    ...
    Pausable
{
    ...
    /**
     * @param _astro astro ERC20 address
        ...
        whenNotPaused
    {
        ...
        astro.mint(msg.sender, calculated);
    }
    ...
    ///@notice returns the current USD price to mint 1 astro Token
